...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-thirdfour w3-container">
      <form action="/student/add_CS" method="post">
      @csrf
        <h5 class="ml3" style="margin-left:20px">加選課程</h5>
        <div style="background-color:MintCream;">
          <br>@php
            if($list->isEmpty()){
                echo "<br><br><center><h4 style='color:#455A64'>暫無課程選擇</h4></center><br>";
            }
            else{
                ...
                echo "</tbody></table></center><br>
                      <center><h5><button name='operation' value='add' class='submit'>加選</button></h5</center>";
            }
            @endphp
          <br>
          <br>
